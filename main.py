...
if __name__ == "__main__":
    ...
    parser.add_argument("--fast_dev_run", type=str, default=0)
    parser.add_argument("--overfit_batches", type=str, default=0)
    parser.add_argument("--limit_train_batches", type=str, default=1.0)
    parser.add_argument("--limit_val_batches", type=str, default=1.0)
    parser.add_argument("--limit_test_batches", type=str, default=1.0)
    parser.add_argument("--accumulate_grad_batches", type=str, default=10)
    parser.add_argument("--detect_anomaly", type=str, default=True)
    parser.add_argument("--log_every_n_steps", type=str, default=100)
    parser.add_argument("--val_check_interval", type=str, default=1000)
